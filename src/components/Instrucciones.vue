          ...
          <v-layout row wrap align-start>
            ...
            <v-flex xs12 md4>
              <v-card flat class="transparent">
                ...
                <v-card-title primary-title class="layout justify-center">
                  <div class="headline text-center"> 2. Aviso de Copyright</div>
                </v-card-title>
                <v-card-text class="text-justify">
          ...
          <v-layout row wrap align-start>
            ...
            <v-flex xs12 md4>
              <v-card flat class="transparent">
                ...
                <v-card-title primary-title class="layout justify-center">
                  <div class="headline text-center"> 5. Registro en la conferencia</div>
                </v-card-title>
                <v-card-text class="text-justify">
            ...
            <v-flex xs12 md3>
              <v-card flat class="transparent">
                ...
                <v-card-text class="text-justify">
                  ...
                  Los autores deben proporcionar una transferencia de derechos de autor. El autor responsable
                  del envío deberá completar y firmar el formulario electrónico de copyright (eCF System). IEEE no
                  permitirá la publicación de documentos de conferencias a menos que se haya completado la
                  transferencia de derechos de autor. El enlace para acceder al formulario será publicado en los
                  próximos días. <br><br>

                  Todas las correcciones deben hacerse antes de continuar con el paso de copyright. Es importante
                  verificar que el título y los autores del artículo sean idénticos al documento final, de lo contrario,
                  el artículo no podrá ser publicado.
          ...
          <v-layout row wrap align-start>
            ...
            <v-flex xs12 md4>
              <v-card flat class="transparent">
                ...
                <v-card-title primary-title class="layout justify-center">
                  <div class="headline text-center"> IMPORTANTE </div>
                </v-card-title>
                <v-card-text class="text-justify">
